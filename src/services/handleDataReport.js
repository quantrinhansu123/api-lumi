...
class HandleDataReport {
    ...
    async processMarketingReport() {
        try {
            ...
            const reportArray = this.initializeReportArray(baoCaoMKTData.data, nhanSuMap);
     ...
     */
    initializeReportArray(baoCaoMKTData, nhanSuMap) {
        return baoCaoMKTData.map(record => {
